...
requirements = python3,kivy,kivymd,pyjnius,requests,urllib3,certifi,chardet,idna,openssl
...
#       [app]
#       title = Folio # This is not a comment, it is part of the title.
#
#   Warning: Indented text is treated as a multiline string - i.e.
#       [app]
#       title = Folio
#          package.name = folio # This is all part of the title.
#
