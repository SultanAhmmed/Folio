...
class DynamicPdfApp(MDApp):
    ...
    json_url = "https://raw.githubusercontent.com/yourusername/yourrepo/main/books.json"
    ...
    def build(self):
        ...
        self.books_list = MDBoxLayout(orientation='vertical', size_hint_y=None, padding=dp(16), spacing=dp(16))
        ...
        # Loading state
        self.loading_label = MDLabel(text="Loading books...", halign="center", theme_text_color="Secondary")
    ...
    def add_book_card(self, book):
        ...
        card = MDCard(
            ...
            size_hint_y=None, height=dp(180), elevation=3, radius=[dp(12)]*4
        )

        card.add_widget(MDLabel(text=title, font_style="H6", theme_text_color="Primary", halign="left"))
        card.add_widget(MDLabel(text=desc, theme_text_color="Secondary", halign="left", wrap=True))
        ...
        btn_color = self.theme_cls.primary_color if is_downloaded else self.theme_cls.accent_color

        btn = MDRaisedButton(text=btn_text, md_bg_color=btn_color, pos_hint={"center_x": .5}, size_hint_x=0.8)
    ...
    def show_error(self):
        self.books_list.clear_widgets()
        self.books_list.add_widget(MDLabel(text="Failed to load books. Check internet.", halign="center", theme_text_color="Error"))
